...
urlpatterns = [
    ...
    # Keep the standalone Nachweis dashboard as a backward-compatible fallback.
    ...
    path('nachweis/plan/drawer/', views.plan_drawer, name='plan_drawer'),
    path('nachweis/profile/drawer/', views.profile_drawer, name='profile_drawer'),
    path('nachweis/application/drawer/', views.application_drawer, name='application_drawer'),
    path('nachweis/application/<int:pk>/inline-update/', views.application_inline_update, name='application_inline_update'),
